...
freqs = json.load(open('../data/'+virus+'_3y_frequencies.json'))
counts = json.load(open('../data/'+virus+'_3y_meta.json'))['virus_stats']
region_names = json.load(open('../data/'+virus+'_3y_meta.json'))['regions']
