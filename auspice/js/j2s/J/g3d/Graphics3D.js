...
Clazz.overrideMethod (c$, "drawQuadrilateralBits", 
function (colix, screenA, screenB, screenC, screenD) {
this.drawLineBits (colix, colix, screenA, screenB);
this.drawLineBits (colix, colix, screenB, screenC);
this.drawLineBits (colix, colix, screenC, screenD);
this.drawLineBits (colix, colix, screenD, screenA);
}, "~N,JU.P3,JU.P3,JU.P3,JU.P3");
Clazz.overrideMethod (c$, "drawTriangleBits", 
function (screenA, colixA, screenB, colixB, screenC, colixC, check) {
if ((check & 1) == 1) this.drawLineBits (colixA, colixB, screenA, screenB);
if ((check & 2) == 2) this.drawLineBits (colixB, colixC, screenB, screenC);
if ((check & 4) == 4) this.drawLineBits (colixA, colixC, screenA, screenC);
}, "JU.P3,~N,JU.P3,~N,JU.P3,~N,~N");
