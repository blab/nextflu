...
function (screenA, colixA, screenB, colixB, screenC, colixC, check) {
var mad = this.exporter.lineWidthMad;
var endcaps = 2;
if ((check & 1) == 1) this.exporter.drawCylinder (screenA, screenB, colixA, colixB, endcaps, mad, 1);
if ((check & 2) == 2) this.exporter.drawCylinder (screenB, screenC, colixB, colixC, endcaps, mad, 1);
if ((check & 4) == 4) this.exporter.drawCylinder (screenA, screenC, colixA, colixC, endcaps, mad, 1);
...
this.setC (colix);
this.fillQuadrilateral (screenA, screenB, screenC, screenD);
}, "~N,JU.P3,JU.P3,JU.P3,JU.P3");
