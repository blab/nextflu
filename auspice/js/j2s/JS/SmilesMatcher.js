...
JS.InvalidSmilesException.clear ();
return (asBioSmiles ? ( new JS.SmilesGenerator ()).getBioSmiles (atoms, ac, bsSelected, bioAllowUnmatchedRings, bioAddCrossLinks, bioComment) : ( new JS.SmilesGenerator ()).getSmiles (atoms, ac, bsSelected, explicitH));
}, "~A,~N,JU.BS,~B,~B,~B,~S,~B");
