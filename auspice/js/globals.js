...
var host_groups = ['turkey', 'Aquatic bird', 'swan', 'group', 'equine', 'wild duch', 'wild bird', 'wild goose', 'gull', 'goosander', 'goose', 'bird', 'ferret', 'swine', 'feline', 'human', 'duck', 'chicken', 'goldenpheasant', 'wild duck'];
var restrictTo = "all";
