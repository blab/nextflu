...
def main():
	...
	process = subprocess.Popen("raxml -f d -T 6 -j -s temp.phyx -n out -c 25 -m GTRCAT -p 344312987 -t initial_tree.newick", shell=True)
	...
	os.system("raxml -f e -T 6 -j -s temp.phyx -n out -c 25 -m GTRCAT -p 344312987 -t final_tree.newick")
	os.rename('RAxML_result.out', 'data/tree.newick')
	cleanup()	
