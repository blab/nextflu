...
qsub -cwd -l h_vmem=8G -l h_rt=10:59:00 submit.sh H3N2 1y
...
qsub -cwd -l h_vmem=8G -l h_rt=10:59:00 submit.sh H1N1pdm 1y
...
qsub -cwd -l h_vmem=8G -l h_rt=10:59:00 submit.sh Vic 1y
...
qsub -cwd -l h_vmem=8G -l h_rt=10:59:00 submit.sh Yam 1y
